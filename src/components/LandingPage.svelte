<script>
	...
	const submittedForm = (/** @type {{ detail: any; }} */ e) => {
			...
			<div class="features-items">
				<article>
					<p class="fontawesome-icon">
						<i class="fas fa-campground fa-lg" />
					</p>
				...
				<article>
					<p class="fontawesome-icon">
						<i class="fas fa-shoe-prints fa-lg" />
					</p>
					<p class="features-item-description">
				...
				<article>
					<p class="fontawesome-icon">
						<i class="fas fa-smile fa-lg" />
					</p>
					<p class="features-item-description">
						Retreat facilitator to manage your day to day activities so you all get a chance to
						reset.
					</p>
				</article>
				<article>
